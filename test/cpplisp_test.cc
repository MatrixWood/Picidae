...
TEST(Cpplisp, cons) {
  using namespace picidae::cpplisp::runtime;
...
TEST(Cpplisp, prettyprint) {
  using namespace picidae::cpplisp::runtime;
  using namespace picidae::cpplisp::runtime::prettyprint;
...
TEST(Cpplisp, append) {
  ...
  EXPECT_EQ(picidae::cpplisp::runtime::prettyprint::to_string(app_ret),
            "(1 . (foo . (2 . nil)))");
...
TEST(Cpplisp, mapcar) {
  ...
  EXPECT_EQ(picidae::cpplisp::runtime::prettyprint::to_string(ls_3),
            "(2 . (3 . (4 . nil)))");
  EXPECT_EQ(picidae::cpplisp::runtime::prettyprint::to_string(ls_4),
            "(1a . (2b . (3c . nil)))");
  EXPECT_EQ(picidae::cpplisp::runtime::prettyprint::to_string(ls_5),
            "(1ae . (2bf . (3cg . nil)))");
}
